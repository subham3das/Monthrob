...
import { Eye, EyeSlash, EnvelopeSimple, Lock, UserCircle, GoogleLogo, ArrowRight, SpinnerGap } from "@phosphor-icons/react";
import { registerUser, googleLoginUser } from "../api";
import { useGoogleLogin } from "@react-oauth/google";

export default function SignupPage({ setAuthUser, setActivePage, setUserProfile }) {
  ...
  const getPasswordStrength = (pw) => {
    if (!pw) return { level: 0, label: "", color: "#E4E4E7" };
    let score = 0;
      ...
      <div className="auth-card">
        ...
        <div className="auth-brand">
          ...
          <p className="auth-brand-subtitle">
            Join our community and discover exclusive streetwear collections.
          </p>
        </div>

        {/* Google Sign In — placed first for signup */}
        <button
        ...
        <form className="auth-form" onSubmit={handleSignup}>
          ...
          <div className="auth-input-group">
            ...
            <div className={`auth-input-wrapper ${focusedField === "confirm" ? "focused" : ""} ${confirmPassword && password !== confirmPassword ? "error" : ""}`}>
              <div className="auth-input-icon">
                <Lock size={18} weight="bold" />
              </div>
              <input
        ...
        <div className="auth-footer">
          <p className="auth-footer-text">
            ...
            <span className="auth-footer-link" onClick={() => setActivePage("login")}>
              Sign In
            </span>
          </p>
        </div>
