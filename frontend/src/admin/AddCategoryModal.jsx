...
export default function AddCategoryModal({ isOpen, onClose, onSave, collections = [] }) {
  ...
  return (
    <div className="modal-overlay">
      <style>{`
        /* Reusing global modal styles if needed, but scoping them here is safe */
        .modal-overlay {
          position: fixed;
      ...
      <div className="modal-content">
        ...
        <div className="modal-body">
          ...
          <div className="form-group">
            ...
            <label className="media-dropzone" htmlFor="category-thumb">
              {thumbnail ? (
        ...
        <div className="modal-footer">
          <button className="btn-save" onClick={handleSave} disabled={isSaving}>{isSaving ? "Saving..." : "Save Category"}</button>
